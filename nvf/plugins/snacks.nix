{ lib, ... }:
{
  ...
  vim.keymaps = [
    ...
    }
    {
      key = "<leader>us";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.option('spell', { name = 'Spelling' })() end";
      lua = true;
    ...
    }
    {
      key = "<leader>uw";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.option('wrap', { name = 'Wrap' })() end";
      lua = true;
      desc = "Toggle Wrap";
    }
    {
      key = "<leader>uL";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.option('relativenumber', { name = 'Relative Number' })() end";
      lua = true;
    ...
    }
    {
      key = "<leader>uc";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.option('conceallevel', { off = 0, on = vim.o.conceallevel > 0 and vim.o.conceallevel or 2, name = 'Conceal Level' })() end";
      lua = true;
    ...
    }
    {
      key = "<leader>uA";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.option('showtabline', { off = 0, on = vim.o.showtabline > 0 and vim.o.showtabline or 2, name = 'Tabline' })() end";
      lua = true;
      desc = "Toggle Tabline";
    }
    {
      key = "<leader>ub";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.option('background', { off = 'light', on = 'dark', name = 'Dark Background' })() end";
      lua = true;
    ...
    }
    {
      key = "<leader>ud";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.diagnostics() end";
      lua = true;
    ...
    }
    {
      key = "<leader>ul";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.line_number() end";
      lua = true;
    ...
    }
    {
      key = "<leader>uT";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.treesitter() end";
      lua = true;
    ...
    }
    {
      key = "<leader>uD";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.dim() end";
      lua = true;
      desc = "Toggle Dim";
    }
    {
      key = "<leader>ua";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.animate() end";
      lua = true;
    ...
    }
    {
      key = "<leader>ug";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.indent() end";
      lua = true;
    ...
    }
    {
      key = "<leader>uS";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.scroll() end";
      lua = true;
    ...
    }
    {
      key = "<leader>uh";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.inlay_hints() end";
      lua = true;
    ...
    }
    {
      key = "<leader>wm";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.zoom() end";
      lua = true;
      desc = "Toggle Zoom";
    }
    {
    ...
    }
    {
      key = "<leader>uz";
      mode = [ "n" ];
      action = "function() require('snacks').toggle.zen() end";
      lua = true;
