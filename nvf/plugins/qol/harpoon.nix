  ...
  vim.extraPlugins = with pkgs.vimPlugins; {
    ...
    harpoon2 = {
      ...
      setup = ''
        ...
        local keys = {
          { "<leader>ha", function() list:add() end, desc = "Add current file to Harpoon" },
          { "<leader>hh", function() harpoon.ui:toggle_quick_menu(list) end, desc = "Harpoon quick menu" },
          { "<leader>hd", function() list:remove() end, desc = "Remove current file from Harpoon" },
          { "[g", function() list:prev() end, desc = "Prev Harpoon File" },
          { "]g", function() list:next() end, desc = "Next Harpoon File" },
        }
