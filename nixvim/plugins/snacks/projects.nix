  ...
  keymaps = [
    {
      key = "<leader>pp";
      mode = "n";
      action.__raw = "function() require('snacks').picker.projects(require('chek.snacks_projects').opts()) end";
      options.desc = "Projects";
    }
    {
      key = "<leader>pz";
      mode = "n";
      action.__raw = "function() require('snacks').picker.zoxide(require('chek.snacks_projects').zoxide_opts()) end";
      options.desc = "Zoxide";
    }
    {
      key = "<leader>pP";
      mode = "n";
      action.__raw = "function() local m = require('chek.snacks_projects'); require('snacks').picker.projects(m.opts({ confirm = m.confirm_tab })) end";
      options.desc = "Projects (new tab)";
    }
    {
      key = "<leader>pZ";
      mode = "n";
      action.__raw = "function() local m = require('chek.snacks_projects'); require('snacks').picker.zoxide(m.zoxide_opts({ confirm = m.confirm_tab })) end";
      options.desc = "Zoxide (new tab)";
    }
    {
      key = "<leader>pd";
      mode = "n";
      action.__raw = "function() require('chek.snacks_projects').show() end";
      options.desc = "Project info";
    }
  ];
}
