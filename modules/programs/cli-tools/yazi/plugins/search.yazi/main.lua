...
local rg_base_command = " rg --hidden --no-messages"
	.. rg_ignores
	.. " --no-heading --smart-case --line-number --color=always "
local fzf_base_command = " fzf --no-multi --height 90% --margin 2% --padding 1% --border sharp --ansi "
...
local function entry(_, job)
	...
	if args[1] == "fzf_content" then
		local rg_fzf_prefix = rg_base_command
			.. " --colors 'match:none' --colors 'match:fg:white' --colors 'match:style:bold' "
